...
if NUM_ARG==2:
   ...
   print 'Usage: '+COMMAND+' [MODEL_FILE] '
   print '  Where MODEL_FILE is the name of the file in the models folder containing the JSON description of a device model. See examples at .models/ '
   sys.exit(2)
...
URL = "http://"+IDAS_HOST+":"+IDAS_ADMIN_PORT+'/m2m/v2/services/'+IDAS_SERVICE+'/models'
